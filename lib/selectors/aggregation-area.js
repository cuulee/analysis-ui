// @flow
/** Convert an aggregation area represented as raster to an outline to display on the map */

import jsolines from 'jsolines'
import {Map as LeafletMap} from 'leaflet'
import {createSelector} from 'reselect'

import type {Feature, Grid} from '../types'

// cut off at cells that are 50% covered by the aggregation area. 30000 would be 30% etc
const CUTOFF = 50000

export function computeOutline (aggregationArea: Grid): void | Feature {
